...
INSERT INTO `user` (`id`, `username`, `password`, `role`, `enabled`, `picture_url`, `description`, `create_date`, `first_name`, `last_name`, `address_id`) VALUES (2, 'EricTheGreat', 'SD', 'USER', 1, 'https://hotpot.ai/s/art-generator/8-a58UmC2ze756cKJ', 'King of chickens', NULL, NULL, NULL, 1);
